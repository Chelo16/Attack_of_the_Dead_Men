...
export class BoardComponent implements OnInit {
  ...
  constructor(private adventureService: GetAdventuresService, private characterService: CharacterService,
    ...
    private rollDice: RollDicesService, router: Router, private moveZombie: MoveZombieService, private zombiesCards: GenerateZombie
  ) {
        ...
        this.adventure.objetivos[i][j].forEach(element => {
          switch(element){
            ...
            case 'Zona Verde':
              ...
              //Te da un string '2 caminante' y tu coges el for de 2 y le metes en esta posicion dos caminantes
          }
        });
        actualColum = (actualColum % 3) + 1;
      }
